...
class HeldoutConditionExecution:
    ...
    def validate(self) -> None:
        ...
        if not self.world_specification_hash:
            raise ValueError("world specification hash is required")
...
def build_result_records(
    ...
    if set(passed) != set(EvidenceDomain):
        raise ValueError("passed-domain mapping must cover exactly EvidenceDomain")
