...
blind_target_selection:
  ...
  authoritative_refs_inspected:
    ...
    - research Candidate #35 frozen scientific source@8ea6581544c642ad74f1a95955ab2c5f795afccc
...
Run close: role performed `INDEPENDENT_AUDITOR`; genuinely new audit issue found `true`; top implication is a treatment/readout causal-opportunity mismatch that makes the Candidate #35 R100 negative non-diagnostic beyond its narrow fixed signature. No scientific result was created. Persistence is limited to the role-separated audit latest/state/history paths.