...
Ops branches are treated as role-separated mailboxes/history only. Scientific state is reconstructed from stable repository content, exact scientific refs, and prospective contracts.
