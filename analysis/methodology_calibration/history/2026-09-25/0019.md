...
R117 methodology history/state was read first. Stable repository/evidence were then independently re-fetched before current Control/Analyst/Theory/Forge mailboxes were used as control-plane context. `ops/*` remains mailbox/history context, not scientific source of truth.
