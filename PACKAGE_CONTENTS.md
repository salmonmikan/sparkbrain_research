# SparkBrain v0.3.2.dev0 Package Contents

- Package version: `0.3.2.dev0`
...
## v0.3.2 development boundary

- `sparkbrain.v032` contains additive corrective APIs; `sparkbrain.v03` remains compatible.
- `docs/V032_IMPLEMENTATION_STATUS.md` records the implementation and intake boundary.
- v0.3.1 release evidence remains historical and is not regenerated by this development commit.
- No scientific claim grade is upgraded.
...
- `src/sparkbrain/v032/`
- `src/sparkbrain/release_atomic.py`
